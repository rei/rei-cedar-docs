...
<cdr-doc-example-code-pair repository-href="/src/components/input" :sandbox-data="Object.assign({}, $page.frontmatter.sandboxData, {loadIcon: true})" :backgroundToggle="false" :codeMaxHeight="false" :model="{defaultModel: ''}">
