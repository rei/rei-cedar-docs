...
Adds `type="date"` to CdrInput to support browser-native date-picking functionality. See the [CdrInput docs page](../../components/input#date-input) for more information.
